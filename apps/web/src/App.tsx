...
export interface ShellContext { readonly session: Session | null | undefined; readonly sessionLoading: boolean; readonly health: HealthResponse | undefined; readonly healthLoading: boolean; readonly healthError: Error | null; }
export const useShellContext = (): ShellContext => useOutletContext<ShellContext>();
